          ...
          <div className="flex items-center gap-3">
             ...
             >
              <div className="hidden lg:block text-right">
                <div className="text-xs font-bold text-white truncate max-w-[140px] font-sans tracking-wide">
                  {userProfile.name.split(' ')[0].toUpperCase()}
                </div>
              </div>
              <div className="w-8 h-8 rounded-md bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-400 font-mono">
